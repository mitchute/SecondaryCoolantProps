...
@click.option('-f', '--fluid', type=fluid_options, required=True, default='water', help="Which fluid to use?")
@click.option('-x', '--concentration', type=x_range, required=False, default=0.0, help="Mixture concentration fraction. Default 0.0.")
@click.option('-p', '--property', 'fluid_prop', type=prop_options, required=True, help="Which fluid property to evaluate.")
@click.option('-t', '--temperature', type=float, required=True, help="Fluid temperature, in degrees Celsius.")
@click.option('-q', "--quick", is_flag=True, show_default=True, default=False, help="Just report the value, good for scripts")

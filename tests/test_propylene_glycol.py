...
class TestPropyleneGlycol(TestCase):
    ...
    def test_1(self):
        ...
        self.assertAlmostEqual(p.density(5), 1.0003e+03, delta=1.0003e+00)

        # SpHt @ T=5degC, X=0: 4.2048e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(5), 4.2048e+03, delta=4.2048e+00)
        ...
        self.assertAlmostEqual(p.density(20), 9.9852e+02, delta=9.9852e-01)

        # SpHt @ T=20degC, X=0: 4.1866e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(20), 4.1866e+03, delta=4.1866e+00)
        ...
        self.assertAlmostEqual(p.density(40), 9.9253e+02, delta=9.9253e-01)

        # SpHt @ T=40degC, X=0: 4.1783e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(40), 4.1783e+03, delta=4.1783e+00)
    ...
    def test_2(self):
        ...
        self.assertAlmostEqual(p.density(5), 1.0191e+03, delta=1.0191e+00)

        # SpHt @ T=5degC, X=20: 3.9459e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(5), 3.9459e+03, delta=3.9459e+00)
        ...
        self.assertAlmostEqual(p.density(20), 1.0148e+03, delta=1.0148e+00)

        # SpHt @ T=20degC, X=20: 3.9768e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(20), 3.9768e+03, delta=3.9768e+00)
        ...
        self.assertAlmostEqual(p.density(40), 1.0064e+03, delta=1.0064e+00)

        # SpHt @ T=40degC, X=20: 4.0190e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(40), 4.0190e+03, delta=4.0190e+00)
    ...
    def test_3(self):
        ...
        self.assertAlmostEqual(p.density(5), 1.0401e+03, delta=1.0401e+00)

        # SpHt @ T=5degC, X=40: 3.6580e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(5), 3.6580e+03, delta=3.6580e+00)
        ...
        self.assertAlmostEqual(p.density(20), 1.0323e+03, delta=1.0323e+00)

        # SpHt @ T=20degC, X=40: 3.7067e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(20), 3.7067e+03, delta=3.7067e+00)
        ...
        self.assertAlmostEqual(p.density(40), 1.0201e+03, delta=1.0201e+00)

        # SpHt @ T=40degC, X=40: 3.7708e+03. Err Tol: 0.1%
        self.assertAlmostEqual(p.specific_heat(40), 3.7708e+03, delta=3.7708e+00)

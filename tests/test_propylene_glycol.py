...
class TestPropyleneGlycolConcentration40(TestCase):
    ...
    def test_viscosity(self):
        # T: 1 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 1, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(1.0), 1.121e-02, delta=1.682e-03)

        # T: 5 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 5, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(5.0), 8.982e-03, delta=1.347e-03)

        # T: 10 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 10, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(10.0), 6.935e-03, delta=1.040e-03)

        # T: 25 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 25, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(25.0), 3.580e-03, delta=5.370e-04)

        # T: 50 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 50, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(50.0), 1.623e-03, delta=2.434e-04)

        # T: 75 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 75, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(75.0), 9.546e-04, delta=1.432e-04)

        # T: 90 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 90, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(90.0), 7.398e-04, delta=1.110e-04)

        # T: 95 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 95, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(95.0), 6.819e-04, delta=1.023e-04)

        # T: 99 [C], Conc: 0.4 [-], ErrTol: 15.0%
        # PropsSI('V', 'P', 101325, 'T', 273.15 + 99, 'INCOMP::MPG[0.4000]')
        self.assertAlmostEqual(self.p.viscosity(99.0), 6.389e-04, delta=9.583e-05)
